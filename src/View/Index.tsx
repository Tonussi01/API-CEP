...
import { CepController } from '../Controller/CepControler';
  ...
  return (
        ...
        >
           <TextInput
            ...
            <Button title="buscar"  onPress={handlerSearcher}/>
            ...
            {loading ? (
                ...
                <Text>   Logradouro:{item.lograduro}    </Text>
